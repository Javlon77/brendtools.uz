@extends('layout')
@section('title', "Izoh qoldirmaydi")
@section('header-text', "Izoh qoldirmaydi")
@section('content')

<div class="container tbl" >
    <p style="color: #29c127">
        * Ushbu sahifa brandtools.uz saytida fikr bildirishni hohlamaganlar uchun! 
    </p>
    <!-- open show link -->
    ...
    <table class="table bg-white" style="width:100%;" id="c-table" data-page-length="10">
        ...
        <tbody>
            ...
            <tr idx="{{ $feedback ->client_id .'#' .$feedback ->sale_id }}">
               ...
               <td style="width:10px">
                <div class="d-flex ">
                    <form action="{{ route('feedbacks.back',[$feedback->id]) }}" method="post" feedback-form="{{ $feedback->id }}">
                        @csrf
                        @method('PUT')
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-body">
            Ushbu mijoz rostdan ham Sharh qoldiradimi?
            Agar "Qoldiradi" tugmasini bossangiz mijoz yana qaytib "Baholangan bo'limiga o'tkaziladi"
        </div>
        <div class="modal-footer">
          <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Bekor qilish</button>
          <button type="button" class="btn btn-danger confirm-set">Qoldiradi</button>
        </div>
      </div>
    </div>
</div>
