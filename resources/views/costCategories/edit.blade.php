@extends('layout')
@section('title', 'Xarajatlar kategoryasini tahrirlash')
@section('header-text', 'Xarajatlar kategoryasini tahrirlash')

@section('content')

<div class="container container-bg">
    
    <form method="post" action="{{ route('cost-categories.update', $category->id) }}">
        @method('PUT')
        @csrf
        @if ($errors->any())
