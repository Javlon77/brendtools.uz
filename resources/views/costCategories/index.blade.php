@extends('layout')
@section('title', 'Xarajat Kategoryalari')
        ...
        @foreach($categories as $category)
            <tr idx="{{ $category->id }}">
                ...
                <td class="align-middle">
                    ...
                    <a href="{{ route('cost-categories.edit',[$category->id])}}" class="btn btn-light edit-btn"><i class="bi bi-pencil-square"></i></a>
                    <form action="{{ route('cost-categories.destroy', $category->id) }}" method="post" category="{{ $category->id }}"> @csrf @method('DELETE') 
