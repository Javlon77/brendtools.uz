@extends('layout') 
@section('title', "Xarajatlar uchun kategorya qo'shish")
@section('header-text', "Xarajatlar uchun kategorya qo'shish")
@section('content')
<div class="container container-bg">
    <form method="post" action="{{ route('cost-categories.store') }}">
        @csrf
